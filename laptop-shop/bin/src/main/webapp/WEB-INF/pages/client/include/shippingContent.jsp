...
<div class ="container">
	<div class="row">
		...
		<div class="col-md-10" class="pull-center">
			<br>
			<img src="Frontend/img/oke5.jpg" alt="">
			
			<br><br>
			<p><b style ="color: #f97281">1. LƯU Ý:</b></p><br>
			...
			<br>
			<p><b style ="color: #f97281">2. BẢNG GIÁ DỊCH VỤ VẨN CHUYỂN HÀNG HÓA</b></p>
			<br>
			
			<table class="table-cart-checkout mytable">
					 <tr>
						    <th style ="color: #f97281">Theo giá trị đơn hàng</th>
						    <th style ="color: #f97281">Số Km được Miễn Phí</th>
						    <th style ="color: #f97281">Thời gian đáp ứng</th>
						    <th style ="color: #f97281">Thu phí</th>
					</tr>
